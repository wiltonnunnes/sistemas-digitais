...
architecture ckt of register13 is

	signal wire1, wire2 : std_logic_vector(12 downto 0);
...
begin
	...
	g21 : mux2x1 port map (I(10), wire2(10), load, wire1(10));
	g22 : ffd port map (clock, wire1(10), '1', '1', wire2(10));
	g23 : mux2x1 port map (I(11), wire2(11), load, wire1(11));
	g24 : ffd port map (clock, wire1(11), '1', '1', wire2(11));
	g25 : mux2x1 port map (I(12), wire2(12), load, wire1(12));
	g26 : ffd port map (clock, wire1(12), '1', '1', wire2(12));
